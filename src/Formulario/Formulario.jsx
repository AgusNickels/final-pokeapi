...
let guardarTel = watch("guardar-tel");
  ...
  return(
    <form className="formulario" onSubmit={ handleSubmit(onSubmit) }>
      <h2>Sumate a la Legión Pokemon</h2>
      ...
      <div className="input-sector">
        ...
        <input type="password" className="input" {...register("password", {
          ...
          pattern:{
            ...
            message: "La contraseña debe tener 1 simbolo, 1 número, 1 Mayúscula y 1 minúscula"
          }
        })}/>
      ...
      <div className="input-sector">
        ...
        {errors.repeatPassword?.type == "validate" && <p className="error">Las contraseñas no coiciden</p>}
      </div>
